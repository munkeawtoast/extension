...
const ActiveItemContent: FC<ActiveItemContentProps> = ({
  baseName,
  image,
  item,
}) => {
  return (
    <div className="font-sans flex bg-[#555] py-2 pl-4 max-w-100">
      <div className="bg-black rounded">
        <div
          ...
          className={classNames(
            ...
            getItemClassnameColor(sku.fromString(item!.sku).quality, null, true)
          )}
        />
      </div>
